...
简单地复习一下第五章的结论，`[[Prototype]]` 机制是一种**存在于一个对象上的内部链接，它指向一个其他对象**。
...
![img](assets/fig4-1548417250479.png)
...
![img](assets/fig5-1548417302260.png)
...
![img](assets/fig6-1548417316214.png)
