> 原文地址：[一篇看懂 React Hooks](https://github.com/ascoders/blog/issues/29) 
...
> 不久前精读分享过的一篇 [Epitath 源码 - renderProps 新用法](https://github.com/dt-fe/weekly/blob/master/75.精读《Epitath 源码 - renderProps 新用法》.md) 就是解决 JSX 嵌套问题，有了 React Hooks 之后，这个问题就被官方正式解决了。
